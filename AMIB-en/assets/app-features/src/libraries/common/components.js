        ...
        [
          {
            ...
            onChange: function (item, name) {
              if (item.borderWidth <= 0) {
                $("#property-roundJoin").hide()
              } else {
                $("#property-roundJoin").show()
              }
            },
          ...
          },
          {
            ...
            values: [
              ...
              { value: "dotted", displayValue: "Dotted" },
        ...
        [
          {
            ...
            onChange: function (item, name) {
              ...
              if (item.typeName == "polygon" || item.typeName == "star") {
                ...
                $("#property-numOfNodes").hide()
              }

              if (item.typeName == "star") {
                $("#property-spikeDepth").show()
              } else {
                $("#property-spikeDepth").hide()
              }
...
prx.types.symbol = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    if (typeof item.scrollToX == "undefined") {
      item.scrollToX = 0
    }
    if (typeof item.scrollToY == "undefined") {
      item.scrollToY = 0
    }
        ...
        [
          {
            ...
            type: "select",
            value: function (item, name) {
              if (typeof prxy.symbols[0] != "undefined" && typeof prxy.symbols[0].states == "undefined") {
                return ""
              }
              if (prx.stc.containers.getIndexFromId(item.symbolid) == -1) {
                return ""
              }
              if (typeof item.symbolstateid == "undefined") {
      ...
      properties: [
        [
          {
            ...
            values: [
              { value: "none", displayValue: "No" },
              { value: "horizontal", displayValue: "Horizontally" },
              { value: "vertical", displayValue: "Vertically" },
              { value: "omni", displayValue: "Omni-directional" },
            ],
            onChange: function (item) {
        ...
        [
          ...
          },
          {
            ...
            type: "select",
            values: [
              { value: "OFF", displayValue: "Don't show scrollbars" },
              { value: "FADE", displayValue: "Visible on scroll only" },
              { value: "ALWAYS", displayValue: "Always visible" },
            ],
            value: function (item, name) {
      ...
      onChange: function (item, that, value) {
        ...
        if (prx.editor) {
          ...
          if (isAutoResize) {
            ...
            $item.width(_width).attr("data-width", _width)
          ...
          var positionWithOffset = prx.items.helper.repositionOnResize(oldItem, newItem, _dims.rotation, _align)
          $iframeRichTextEL.width(_width).height(_height)
        ...
        [
          {
            ...
            onChange: function (item) {
              ...
              positionWithOffset = prx.items.helper.repositionOnResize(oldItem, newItem, _dims.rotation, _align)
              prxy.items[_index].left = positionWithOffset.x
              prxy.items[_index].top = positionWithOffset.y
        ...
        [
          {
            ...
            changeProperty: {
              ...
              changeFunction: function (item, containerid, duration, easing, dynPropI) {
                prx.componentsHelper.changeFunctionForTextFontStyleProperties(item, containerid, dynPropI, "textFontStyle")
              },
            },
          },
          {
        ...
        [
          {
            ...
            values: [{ value: "underline", displayValue: "", icon: "text-underline" }],
            onChange: function (item) {
              var isAutoResize = item.autoResize == true ? true : false
              var wordWrapVal = isAutoResize == true ? "nowrap" : "normal"
              var $item = $("#" + item.id)
            ...
            changeProperty: {
              ...
              transitionable: false,
              changeFunction: function (item, containerid, duration, easing, dynPropI) {
                prx.componentsHelper.changeFunctionForTextProperties(item, containerid, dynPropI, "textProperties")
              },
            },
          },
          {
        ...
        [
          {
            ...
            onClick: function (item) {
              ...
              if (_width > canvasWidth && isAutoResize) {
                //in case autoresize true but using lorem ipsum is going to create a very wide textbox, then convert to fixed
                convertToFixed = true
        ...
        [
          {
            ...
            type: "select",
            value: function (item, name) {
              if (typeof item.backgroundSizeType == "undefined") {
                item.backgroundSizeType = "cover"
              }
            ...
            values: [
              { value: "cover", displayValue: "Cover" },
          ...
          },
          {
            ...
            type: "slider-input",
            value: function (item, name) {
              if (typeof item.backgroundSizeValue == "undefined") {
                item.backgroundSizeValue = 35
              }
        ...
        [
          {
            ...
            values: [
              { value: "0px", displayValue: "0px" },
              { value: "1px", displayValue: "1px" },
              {
                value: "2px",
                displayValue: "2px",
              },
              { value: "3px", displayValue: "3px" },
              { value: "4px", displayValue: "4px" },
              {
                value: "5px",
                displayValue: "5px",
              },
              { value: "6px", displayValue: "6px" },
              { value: "7px", displayValue: "7px" },
              {
                value: "8px",
                displayValue: "8px",
              },
              { value: "9px", displayValue: "9px" },
              ...
              { value: "13px", displayValue: "13px" },
              {
                value: "14px",
                displayValue: "14px",
              },
              { value: "15px", displayValue: "15px" },
...
prx.types.image = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    if (prx.urlCache != undefined) thumbUrl = prx.urlCache.thumbs[prx.componentsHelper.getProp(item.imgSrc.fileId, "other")] || ""

    var missing = prx.url.static + "/images/editor/missing.png"

    if (prx.editor) {
      if ($("#image-load-container").length == 0) $('<div id="image-load-container"></div>').appendTo("body")
    ...
    if (prx.mask.isActive(item)) cR += prx.items.getComponentPrependDivs(item, containerid, symbol, thumbUrl2)
    else cR += prx.items.getComponentPrependDivs(item, containerid, symbol, "")

    cR += '<div class="image-inner borderPos-' + prx.componentsHelper.getProp(item.borderPos, "other") + '">'

    cR += '<div id="' + _id + '-img-wrapper" class="type-image-wrapper liveUpdate-borderColor-border-color changeProperty-borderColor changeProperty-borderRadius changeProperty-borderWidth ' + (item.imgSrc.fileId !== undefined && prx.componentsHelper.getProp(item.imgSrc.fileId.slice(-4), "other") == ".svg" ? " type-image-svg" : "") + missingClass + (prx.componentsHelper.getProp(item.repeat, "boolean") ? " type-image-repeater" : "") + (fileType == "gif" ? " gif" : "") + '" ' + 'style="background-image: url(' + wrapperBackground + ');">'

    cR += "<div></div>"

    var tempH = item.height,
      tempW = item.width
    ...
    if (assetUrl == missing) cR += "<div>" + prx.utils.escapeHTML(item.caption) + "</div>"
        ...
        [
          {
            caption: function (item) {
              ...
              if (multiplier !== false) return "Reset to " + multiplier + "x size (original)"
              else return "Reset to original size"
            },
            ...
            hiddenByDefault: function (item) {
              if (prx.mask.isActive(item) || prx.mask.editModeIsMaskSelected(item)) return true
              else return false
            },
          },
        ],
            ...
            onClick: function (item) {
              if ($.browser.msie) {
                $("#" + item.id + " > img")
                  ...
                  .prop("naturalWidth", $("#" + item.id + " img").width())
                  .prop("naturalHeight", $("#" + item.id + " img").height())
              }
        ...
        [
          {
            ...
            hiddenByDefault: function (item) {
              ...
              if (prx.mask.isActive(item) || prx.mask.editModeIsMaskSelected(item)) r = r || true
              else r = r || false
        ...
        [
          {
            ...
            onChange: function (item) {
              ...
              if (tmp) prx.mask.enable(item)
              else prx.mask.disable(item)
        ...
        [
          {
            ...
            hiddenByDefault: function (item) {
              ...
              if (!prx.mask.isActive(item)) r = r || true
              else r = r || false
        ...
        [
          {
            ...
            values: [
              { displayValue: "Inside", value: "inside" },
              { displayValue: "Outside", value: "outside" },
            ],
            changeProperty: {
        ...
        [
          {
            ...
            hiddenByDefault: function (item) {
              if (prx.mask.isEditing(item)) return true
              else return false
            },
          },
        ],
...
prx.types.video = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    if (typeof item.vimeoid == "undefined") {
      item.vimeoid = ""
    }
    if (typeof item.loop == "undefined") {
      item.loop = false
        ...
        [
          {
            ...
            values: [
              { displayValue: "Uploaded video", value: "html5" },
              { displayValue: "YouTube video", value: "youtube" },
              { displayValue: "Vimeo video", value: "vimeo" },
            ],
            onChange: function (item) {
              //if(item.videoType == 'youtube') {
...
prx.types.tooltip = {
  ...
  onResize: function (item, containerid, symbol) {
    ...
    switch (item.ttDirection) {
      ...
      case "bottom":
        ...
        $("#" + _id + " .tooltip-outer")
          .first()
          .css("left", eval((_dims.width * item.ttPosition) / 100 - (25 * prx.componentsHelper.getScale(item.lib) * item.ttPosition) / 100) + "px")
        break
      case "left":
      case "right":
        _height = "100%"
        ...
        $("#" + _id + " .tooltip-outer")
          .first()
          .css("top", eval((_dims.height * item.ttPosition) / 100 - (25 * prx.componentsHelper.getScale(item.lib) * item.ttPosition) / 100) + "px")
        break
      case "none":
        _height = "100%"
        _width = "100%"
  ...
  propertyGroups: [
        ...
        [
          {
            ...
            values: [
              ...
              { value: "none", displayValue: "No tooltip" },
            ],
            changeProperty: {
    ...
    {
      caption: "Text",
      properties: [[prx.commonproperties.textFontRichText("font-family", "text")], [prx.commonproperties.textFontStyleRichText(["font-weight", "font-style"], "text", false, { propName: "textFontStyle", caption: "Text Font style", useAsDynProp: false }), prx.commonproperties.textSizeRichText("font-size", "text")], [prx.commonproperties.textPropertiesRichText(["font-weight", "font-style", "text-decoration"], "text", false, { propName: "textProperties", caption: "Underline", useAsDynProp: false }), prx.commonproperties.textColorRichText("color", "text")], [prx.commonproperties.textAlign]],
    },
  ],
}
...
prx.types.basic_button_bg = {
  ...
  propertyGroups: [
    ...
    },
    {
      ...
      properties: [
        [
          Object.assign(prx.commonproperties.textFont, {
            hiddenByDefault: function (item) {
        ...
        [
          Object.assign(prx.commonproperties.textFontStyle, {
            hiddenByDefault: function (item) {
              return item.iconpos === "notext"
            },
          }),
          Object.assign(prx.commonproperties.textSize, {
            hiddenByDefault: function (item) {
              return item.iconpos === "notext"
            },
          }),
        ...
        [
          Object.assign(prx.commonproperties.textPropertiesRichText(["font-weight", "font-style", "text-decoration"], "text", false, { propName: "textProperties", caption: "Underline", useAsDynProp: false }), {
            hiddenByDefault: function (item) {
              return item.iconpos === "notext"
            },
          }),
        ...
        [
          {
            ...
            values: [
              { value: "none", displayValue: "No icon" },
              { value: "left", displayValue: "Left" },
              { value: "right", displayValue: "Right" },
              { value: "notext", displayValue: "Icon only (no text)" },
            ],
            onChange: function (item) {
          ...
          },
          {
            ...
            values: [
              { value: "1", displayValue: "Very small" },
              { value: "2", displayValue: "Small" },
              { value: "3", displayValue: "Normal" },
              { value: "4", displayValue: "Large" },
              { value: "5", displayValue: "Full" },
            ],
            changeProperty: {
              caption: "Icon size",
              rerender: true,
    ...
    if (!prx.editor) {
      prx.draggable._draggables["#" + _id + " .slider-button"] = Draggable.create("#" + _id + " .slider-button", {
        ...
        onDragStart: function () {
          ...
          if (typeof prx.variables._triggerData["#" + _id] == "undefined") {
            prx.variables._triggerData["#" + _id] = {}
          }
...
prx.types.vectoranimation = {
            ...
            anim.addEventListener("DOMLoaded", function () {
              ...
              if (_onCreate) {
                prx.bodymovinAnimation.playbackConsole({
                  playbackType: "play",
                  target: { search: false, dataName: _id },
                  onCompleteEvent: function event() {
                    $("#" + _id)
                      .find("#playVectorAnimationprop")
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    if (prx.editor) {
      ...
      if (assetUrl == missing || prx.componentsHelper.getProp(item.imgSrc.fileId, "other") == "") cR += "<div>" + prx.utils.escapeHTML(item.caption) + "</div>"
    } else {
...
prx.types.basic_tabbar = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    if (typeof item.changeActive == "undefined") {
    ...
    $.each(item.tabs, function (i, elm) {
      if (typeof elm.linkedscreen == "undefined") {
        elm.linkedscreen = -1
      }
  ...
  propertyGroups: [
    ...
    },
    {
      ...
      properties: [
        ...
        [
          prx.commonproperties.textFontStyleRichText(
            ["font-weight", "font-style"],
            ["tabs.text"],
            function (item) {
              return item.iconpos == "notext"
            },
            { propName: "textFontStyle", caption: "Text Font Style", useAsDynProp: false }
          ),
          {
            caption: false,
            name: "textSize",
        ...
        [
          prx.commonproperties.textPropertiesRichText(
            ["font-weight", "font-style", "text-decoration"],
            ["tabs.text"],
            function (item) {
              return item.iconpos == "notext"
            },
            { propName: "textProperties", caption: "Underline", useAsDynProp: false }
          ),
          {
        ...
        [
          ...
          },
          {
            caption: function (item, name) {
              if (item.name === "basic_tabbar_icon" || item.name === "basic_tabbar_texticon") return "Size"
              return false
            },
            name: "iconSize",
            proptype: "icon-size",
...
prx.types.datetime = {
  ...
  propertyGroups: [
    ...
    {
      caption: "Text",
      properties: [[prx.commonproperties.textFont], [prx.commonproperties.textFontStyle, prx.commonproperties.textSize], [prx.commonproperties.textProperties, prx.commonproperties.textColor()], [prx.commonproperties.textAlign]],
    },
    {
      caption: "Format",
      properties: [
